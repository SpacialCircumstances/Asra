...
let testCases () = 
    [
        ...
        "", []
        "fun let -> else if then if2 type do", [ Fun; Let; Arrow; Else; If; Then; Identifier "if2"; Type; Do ]
        """
        "Test", "sdf", 23, ad
        """, [ StringLiteral "Test"; Comma; StringLiteral "sdf"; Comma; NumberLiteral "23"; Comma; Identifier "ad" ]
